  ...
  return (
    <div className='product-tag-root padding'>
        <div className='sub-container product-tag-box padding-y-axis'>
          ...
          <p className='subtext'>At Biobox Pharma, we are redefining healthcare through cutting-edge innovation and unwavering excellence. Our commitment to advanced research and quality ensures superior solutions for a healthier future.</p>
        </div>
    </div>
  )
}
